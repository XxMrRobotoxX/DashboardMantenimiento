...
try:
    ...
    if (date_filter == ()):
        ...
        #data_rnd = df_filtered['FechaInicio'].iloc[0]
        df_filtered = df_filtered[(df_filtered["Estatus"] == "Cerrada") & (df_filtered["CausoParo"] == "Si") & (df_filtered['FechaInicio'].between(date_filter[0],date_filter[1],inclusive='both'))]
